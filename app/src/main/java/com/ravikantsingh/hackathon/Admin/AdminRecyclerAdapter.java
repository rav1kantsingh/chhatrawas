...
public class AdminRecyclerAdapter extends RecyclerView.Adapter<AdminRecyclerAdapter.ViewHolder> {
    ...
    public AdminRecyclerAdapter(Context context,List<AdminModal> list){
        this.context = context;
        this.list = list;
    }

    public AdminRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdminRecyclerAdapter.ViewHolder viewHolder, int i) {
